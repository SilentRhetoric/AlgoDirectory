...
export const DataTable = <TData, TValue>(props: Props<TData, TValue>) => {
  ...
  return (
    <div class="w-full space-y-2.5">
      ...
      <div class="flex flex-col-reverse justify-between items-center gap-4 sm:flex-row">
        <div class="flex items-center justify-center whitespace-nowrap text-sm px-1">
