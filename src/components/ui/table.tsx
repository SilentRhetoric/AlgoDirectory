...
export const TableFooter = (props: ComponentProps<"tfoot">) => {
  ...
  return (
    <tbody
      class={cn("bg-primary font-thin text-primary-foreground", local.class)}
      {...rest}
    />
  )
}
...
export const TableHead = (props: ComponentProps<"th">) => {
  ...
  return (
    <th
      class={cn(
        "h-10 px-2 text-left align-middle font-thin uppercase text-muted-foreground [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px]",
        local.class,
      )}
      {...rest}
    />
